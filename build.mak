export PJDIR := /Users/taoyanbo/Documents/asterisk/pjproject-2.8-vos
...
export APP_CC := /Users/taoyanbo/Documents/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/darwin-x86_64/bin/aarch64-linux-android-gcc
export APP_CXX := /Users/taoyanbo/Documents/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/darwin-x86_64/bin/aarch64-linux-android-g++
...
export APP_CXXFLAGS :=  -shared --sysroot=/Users/taoyanbo/Documents/android-ndk-r14b/platforms/android-21/arch-arm64 -lgcc -no-canonical-prefixes -Wl,--build-id -Wl,--no-undefined -Wl,-z,noexecstack -Wl,-z,relro -Wl,-z,now -Wl,--warn-shared-textrel -Wl,--fatal-warnings -lc -lm -fexceptions -frtti $(APP_CFLAGS)
export APP_LDFLAGS := -L$(PJDIR)/pjlib/lib\
	...
	$(PJ_VIDEO_LDFLAGS) \
	 --sysroot=/Users/taoyanbo/Documents/android-ndk-r14b/platforms/android-21/arch-arm64 -L/Users/taoyanbo/Documents/android-ndk-r14b/sources/cxx-stl/gnu-libstdc++/4.9/libs/arm64-v8a/ -L../openssl/arm64-v8a/lib
...
export PJ_INSTALL_CXXFLAGS :=  -shared --sysroot=/Users/taoyanbo/Documents/android-ndk-r14b/platforms/android-21/arch-arm64 -lgcc -no-canonical-prefixes -Wl,--build-id -Wl,--no-undefined -Wl,-z,noexecstack -Wl,-z,relro -Wl,-z,now -Wl,--warn-shared-textrel -Wl,--fatal-warnings -lc -lm -fexceptions -frtti $(PJ_INSTALL_CFLAGS)
